...
public class CSItems { public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(ChemicalScience.MOD_ID);
    ...
    /** Raw ores */
    public static final DeferredItem<Item> RAW_ORE_MAGNESIUM= ITEMS.register("rawore_magnesium", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> DUST_SODIUM = ITEMS.register("dust_sodium", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> DUST_MANGANESE = ITEMS.register("dust_manganese", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> DUST_SELENIUM = ITEMS.register("dust_selenium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> DUST_RUBIDIUM = ITEMS.register("dust_rubidium", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> DUST_CADMIUM = ITEMS.register("dust_cadmium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> DUST_INDIUM = ITEMS.register("dust_indium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> DUST_ANTIMONY = ITEMS.register("dust_antimony", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> DUST_TELLURIUM = ITEMS.register("dust_tellurium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> DUST_IODINE = ITEMS.register("dust_iodine", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> DUST_CESIUM = ITEMS.register("dust_cesium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> DUST_BARIUM = ITEMS.register("dust_barium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> DUST_HAFNIUM = ITEMS.register("dust_hafnium", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> DUST_RHENIUM = ITEMS.register("dust_rhenium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> DUST_OSMIUM = ITEMS.register("dust_osmium", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> DUST_CERIUM = ITEMS.register("dust_cerium", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> DUST_THORIUM = ITEMS.register("dust_thorium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> DUST_URANIUM = ITEMS.register("dust_uranium", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> IMPURE_DUST_SODIUM = ITEMS.register("impuredust_sodium", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> IMPURE_DUST_CERIUM = ITEMS.register("impuredust_cerium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_MANGANESE = ITEMS.register("impuredust_manganese", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> IMPURE_DUST_GERMANIUM = ITEMS.register("impuredust_germanium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_ARSENIC = ITEMS.register("impuredust_arsenic", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_SELENIUM = ITEMS.register("impuredust_selenium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_RUBIDIUM = ITEMS.register("impuredust_rubidium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_STRONTIUM = ITEMS.register("impuredust_strontium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_YTTRIUM = ITEMS.register("impuredust_yttrium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_NIOBIUM = ITEMS.register("impuredust_niobium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_HAFNIUM = ITEMS.register("impuredust_hafnium", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> IMPURE_DUST_RHENIUM = ITEMS.register("impuredust_rhenium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_OSMIUM = ITEMS.register("impuredust_osmium", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> IMPURE_DUST_MERCURY = ITEMS.register("impuredust_mercury", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_BISMUTH = ITEMS.register("impuredust_bismuth", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_RHODIUM = ITEMS.register("impuredust_rhodium", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> IMPURE_DUST_CADMIUM = ITEMS.register("impuredust_cadmium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_ANTIMONY = ITEMS.register("impuredust_antimony", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_TELLURIUM = ITEMS.register("impuredust_tellurium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_IODINE = ITEMS.register("impuredust_iodine", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_CESIUM = ITEMS.register("impuredust_cesium", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IMPURE_DUST_BARIUM = ITEMS.register("impuredust_barium", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> IMPURE_DUST_THORIUM = ITEMS.register("impuredust_thorium", () -> new Item(new Item.Properties()));
