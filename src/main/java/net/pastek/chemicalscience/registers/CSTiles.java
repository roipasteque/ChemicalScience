...
public class CSTiles {
    ...
    public static final RegistryObject<BlockEntityType<TileFuelCell>> TILE_FUELCELL = BLOCK_ENTITY_TYPES.register(SubtypeChemicalMachine.fuelcell.tag(), () -> new BlockEntityType<>(TileFuelCell::new, Sets.newHashSet(CSBlocks.FUEL_CELL.get()), null));
