package net.pastek.chemicalscience.prefab.utils;
...
public class CSTextUtils {
    ...
    public static MutableComponent translated(String base, String key, Object... additional) {
        return Component.translatable(base + "." + ChemicalScience.MOD_ID + "." + key, additional);
    }
    ...
    public static boolean translationExists(String base, String key) {
        return I18n.exists(base + "." + ChemicalScience.MOD_ID + "." + key);
    }
