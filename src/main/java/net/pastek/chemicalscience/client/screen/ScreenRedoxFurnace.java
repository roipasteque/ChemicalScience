...
@OnlyIn(Dist.CLIENT)
public class ScreenRedoxFurnace extends GenericMaterialScreen<ContainerRedoxFurnace> {
    public ScreenRedoxFurnace(ContainerRedoxFurnace container, Inventory playerInventory, Component title) {
        super(container, playerInventory, title);

        this.defaultResource = ChemicalScience.rl("textures/screen/gui/redoxfurnace_gui.png");
