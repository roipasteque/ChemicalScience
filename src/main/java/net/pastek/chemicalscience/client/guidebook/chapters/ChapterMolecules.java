...
public class ChapterMolecules extends Chapter {
    ...
    public void addData() {
        ...
        //Ammonium Diuranate
        pageData.add(new ItemWrapperObject(15, 10, 32, 32, 50, 2.0F, CSItems.AMMONIUMDIURANATE.get(), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 10, CSItems.AMMONIUMDIURANATE.get().getDescription().copy().withStyle(ChatFormatting.UNDERLINE).withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting.DARK_BLUE)), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 20,
                CSTextUtils.guidebook("chapter.molecules.ammoniumdiuranate"))).onTooltip(new OnTooltip() {
            @Override public void onTooltip(GuiGraphics graphics, int xAxis, int yAxis, ScreenGuidebook screen) {if (JeiBuffer.isJeiInstalled()) {graphics.renderTooltip(screen.getFontRenderer(), ElectroTextUtils.tooltip("guidebookjeiuse").withStyle(ChatFormatting.GRAY), xAxis, yAxis);}}}).onKeyPress(new OnKeyPress() {@Override public void onKeyPress(int keyCode, int scanCode, int modifiers, int x, int y, int xAxis, int yAxis, ScreenGuidebook screen) {}@Override public Object getJeiLookup() {return new ItemStack(CSItems.AMMONIUMDIURANATE.get());}}));
        pageData.add(new ImageWrapperObject(20, 0, 0, 0, 100, 75, 100, 75,
                ResourceLocation.fromNamespaceAndPath(ChemicalScience.MOD_ID,"textures/screen/guidebook/molecules/ammoniumdiuranate.png")));

        //Caffeine
        pageData.add(new ItemWrapperObject(15, 10, 32, 32, 50, 2.0F, CSItems.CAFFEINE.get(), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 10, CSItems.CAFFEINE.get().getDescription().copy().withStyle(ChatFormatting.UNDERLINE).withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting.DARK_BLUE)), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 20,
                CSTextUtils.guidebook("chapter.molecules.caffeine"))).onTooltip(new OnTooltip() {
            @Override public void onTooltip(GuiGraphics graphics, int xAxis, int yAxis, ScreenGuidebook screen) {if (JeiBuffer.isJeiInstalled()) {graphics.renderTooltip(screen.getFontRenderer(), ElectroTextUtils.tooltip("guidebookjeiuse").withStyle(ChatFormatting.GRAY), xAxis, yAxis);}}}).onKeyPress(new OnKeyPress() {@Override public void onKeyPress(int keyCode, int scanCode, int modifiers, int x, int y, int xAxis, int yAxis, ScreenGuidebook screen) {}@Override public Object getJeiLookup() {return new ItemStack(CSItems.CAFFEINE.get());}}));
        pageData.add(new ImageWrapperObject(20, 0, 0, 0, 100, 75, 100, 75,
        ...
        //Dimethyl Urea
        pageData.add(new ItemWrapperObject(15, 10, 32, 32, 50, 2.0F, CSItems.DIMETHYLUREA.get(), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 10, CSItems.DIMETHYLUREA.get().getDescription().copy().withStyle(ChatFormatting.UNDERLINE).withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting.DARK_BLUE)), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 20,
                CSTextUtils.guidebook("chapter.molecules.dimethylurea"))).onTooltip(new OnTooltip() {
            @Override public void onTooltip(GuiGraphics graphics, int xAxis, int yAxis, ScreenGuidebook screen) {if (JeiBuffer.isJeiInstalled()) {graphics.renderTooltip(screen.getFontRenderer(), ElectroTextUtils.tooltip("guidebookjeiuse").withStyle(ChatFormatting.GRAY), xAxis, yAxis);}}}).onKeyPress(new OnKeyPress() {@Override public void onKeyPress(int keyCode, int scanCode, int modifiers, int x, int y, int xAxis, int yAxis, ScreenGuidebook screen) {}@Override public Object getJeiLookup() {return new ItemStack(CSItems.DIMETHYLUREA.get());}}));
        pageData.add(new ImageWrapperObject(20, 0, 0, 0, 100, 75, 100, 75,
        ...
        //Nitrochlorobenzene
        pageData.add(new ItemWrapperObject(15, 10, 32, 32, 50, 2.0F, CSItems.NITROCHLOROBENZENE.get(), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 10, CSItems.NITROCHLOROBENZENE.get().getDescription().copy().withStyle(ChatFormatting.UNDERLINE).withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting.DARK_BLUE)), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 20,
                CSTextUtils.guidebook("chapter.molecules.nitrochlorobenzene"))).onTooltip(new OnTooltip() {
            @Override public void onTooltip(GuiGraphics graphics, int xAxis, int yAxis, ScreenGuidebook screen) {if (JeiBuffer.isJeiInstalled()) {graphics.renderTooltip(screen.getFontRenderer(), ElectroTextUtils.tooltip("guidebookjeiuse").withStyle(ChatFormatting.GRAY), xAxis, yAxis);}}}).onKeyPress(new OnKeyPress() {@Override public void onKeyPress(int keyCode, int scanCode, int modifiers, int x, int y, int xAxis, int yAxis, ScreenGuidebook screen) {}@Override public Object getJeiLookup() {return new ItemStack(CSItems.NITROCHLOROBENZENE.get());}}));
        pageData.add(new ImageWrapperObject(20, 0, 0, 0, 100, 75, 100, 75,
        ...
        pageData.add(new ItemWrapperObject(15, 10, 32, 32, 50, 2.0F, CSItems.PARAPHENYLENEDIAMINE.get(), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 10, CSItems.PARAPHENYLENEDIAMINE.get().getDescription().copy().withStyle(ChatFormatting.UNDERLINE).withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting.DARK_BLUE)), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 20,
                CSTextUtils.guidebook("chapter.molecules.paraphenylenediamine"))).onTooltip(new OnTooltip() {
            @Override public void onTooltip(GuiGraphics graphics, int xAxis, int yAxis, ScreenGuidebook screen) {if (JeiBuffer.isJeiInstalled()) {graphics.renderTooltip(screen.getFontRenderer(), ElectroTextUtils.tooltip("guidebookjeiuse").withStyle(ChatFormatting.GRAY), xAxis, yAxis);}}}).onKeyPress(new OnKeyPress() {@Override public void onKeyPress(int keyCode, int scanCode, int modifiers, int x, int y, int xAxis, int yAxis, ScreenGuidebook screen) {}@Override public Object getJeiLookup() {return new ItemStack(CSItems.PARAPHENYLENEDIAMINE.get());}}));
        pageData.add(new ImageWrapperObject(20, 0, 0, 0, 100, 75, 100, 75,
        ...
        pageData.add(new ItemWrapperObject(15, 10, 32, 32, 50, 2.0F, CSItems.TEREPHTHALOYLCHLORIDE.get(), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 10, CSItems.TEREPHTHALOYLCHLORIDE.get().getDescription().copy().withStyle(ChatFormatting.UNDERLINE).withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting.DARK_BLUE)), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 20,
                CSTextUtils.guidebook("chapter.molecules.terephthaloylchloride"))).onTooltip(new OnTooltip() {
            @Override public void onTooltip(GuiGraphics graphics, int xAxis, int yAxis, ScreenGuidebook screen) {if (JeiBuffer.isJeiInstalled()) {graphics.renderTooltip(screen.getFontRenderer(), ElectroTextUtils.tooltip("guidebookjeiuse").withStyle(ChatFormatting.GRAY), xAxis, yAxis);}}}).onKeyPress(new OnKeyPress() {@Override public void onKeyPress(int keyCode, int scanCode, int modifiers, int x, int y, int xAxis, int yAxis, ScreenGuidebook screen) {}@Override public Object getJeiLookup() {return new ItemStack(CSItems.TEREPHTHALOYLCHLORIDE.get());}}));
        pageData.add(new ImageWrapperObject(20, 0, 0, 0, 100, 75, 100, 75,
        ...
        //Succinimide
        pageData.add(new ItemWrapperObject(15, 10, 32, 32, 50, 2.0F, CSItems.SUCCINIMIDE.get(), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 10, CSItems.SUCCINIMIDE.get().getDescription().copy().withStyle(ChatFormatting.UNDERLINE).withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting.DARK_BLUE)), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 20,
                CSTextUtils.guidebook("chapter.molecules.succinimide"))).onTooltip(new OnTooltip() {
            @Override public void onTooltip(GuiGraphics graphics, int xAxis, int yAxis, ScreenGuidebook screen) {if (JeiBuffer.isJeiInstalled()) {graphics.renderTooltip(screen.getFontRenderer(), ElectroTextUtils.tooltip("guidebookjeiuse").withStyle(ChatFormatting.GRAY), xAxis, yAxis);}}}).onKeyPress(new OnKeyPress() {@Override public void onKeyPress(int keyCode, int scanCode, int modifiers, int x, int y, int xAxis, int yAxis, ScreenGuidebook screen) {}@Override public Object getJeiLookup() {return new ItemStack(CSItems.SUCCINIMIDE.get());}}));
        pageData.add(new ImageWrapperObject(20, 0, 0, 0, 100, 75, 100, 75,
                ResourceLocation.fromNamespaceAndPath(ChemicalScience.MOD_ID,"textures/screen/guidebook/molecules/succinimide.png")));

        //Nbromosuccinimide
        pageData.add(new ItemWrapperObject(15, 10, 32, 32, 50, 2.0F, CSItems.NBROMOSUCCINIMIDE.get(), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 10, CSItems.NBROMOSUCCINIMIDE.get().getDescription().copy().withStyle(ChatFormatting.UNDERLINE).withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting.DARK_BLUE)), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 20,
                CSTextUtils.guidebook("chapter.molecules.nbromosuccinimide"))).onTooltip(new OnTooltip() {
            @Override public void onTooltip(GuiGraphics graphics, int xAxis, int yAxis, ScreenGuidebook screen) {if (JeiBuffer.isJeiInstalled()) {graphics.renderTooltip(screen.getFontRenderer(), ElectroTextUtils.tooltip("guidebookjeiuse").withStyle(ChatFormatting.GRAY), xAxis, yAxis);}}}).onKeyPress(new OnKeyPress() {@Override public void onKeyPress(int keyCode, int scanCode, int modifiers, int x, int y, int xAxis, int yAxis, ScreenGuidebook screen) {}@Override public Object getJeiLookup() {return new ItemStack(CSItems.NBROMOSUCCINIMIDE.get());}}));
        pageData.add(new ImageWrapperObject(20, 0, 0, 0, 100, 75, 100, 75,
                ResourceLocation.fromNamespaceAndPath(ChemicalScience.MOD_ID,"textures/screen/guidebook/molecules/nbromosuccinimide.png")));

        //Urea
        pageData.add(new ItemWrapperObject(15, 10, 32, 32, 50, 2.0F, CSItems.UREA.get(), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 10, CSItems.UREA.get().getDescription().copy().withStyle(ChatFormatting.UNDERLINE).withStyle(ChatFormatting.BOLD).withStyle(ChatFormatting.DARK_BLUE)), new AbstractGraphicWrapper.GraphicTextDescriptor(40, 20,
                CSTextUtils.guidebook("chapter.molecules.urea"))).onTooltip(new OnTooltip() {
        @Override public void onTooltip(GuiGraphics graphics, int xAxis, int yAxis, ScreenGuidebook screen) {if (JeiBuffer.isJeiInstalled()) {graphics.renderTooltip(screen.getFontRenderer(), ElectroTextUtils.tooltip("guidebookjeiuse").withStyle(ChatFormatting.GRAY), xAxis, yAxis);}}}).onKeyPress(new OnKeyPress() {@Override public void onKeyPress(int keyCode, int scanCode, int modifiers, int x, int y, int xAxis, int yAxis, ScreenGuidebook screen) {}@Override public Object getJeiLookup() {return new ItemStack(CSItems.UREA.get());}}));
        pageData.add(new ImageWrapperObject(20, 0, 0, 0, 100, 75, 100, 75,
