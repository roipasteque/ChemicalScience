...
public class RenderFractionatingColumn extends AbstractTileRenderer<TileFractionatingColumn> {
    ...
    @Override
    public AABB getRenderBoundingBox(TileFractionatingColumn tile) {
    ...
    @Override
    public boolean shouldRenderOffScreen(TileFractionatingColumn blockEntity) {
        return true;
    }

    @Override
    public void render(@NotNull TileFractionatingColumn tile, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
