...
public class CSBlockStateProvider extends BaseBlockstateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        stairsBlock(CSBlocks.ASPHALT_STAIR.get(),blockTexture(CSBlocks.ASPHALT_BLOCK.get()));
        slabBlock(CSBlocks.ASPHALT_SLAB.get(), blockTexture(CSBlocks.ASPHALT_BLOCK.get()), blockTexture(CSBlocks.ASPHALT_BLOCK.get()));
    ...
    private void buildingBlockWithItem(RegistryObject<Block> blockRegistryObject) {
        String path = blockRegistryObject.getId().getPath();
    ...
    private void blockItem(RegistryObject<Block> blockRegistryObject) {
        simpleBlockItem(blockRegistryObject.get(), new ModelFile.UncheckedModelFile("chemicalscience:block/" + blockRegistryObject.getId().getPath()));
    }
    private void blockItem(RegistryObject<Block> blockRegistryObject, String loc, String appendix) {
        simpleBlockItem(blockRegistryObject.get(), new ModelFile.UncheckedModelFile("chemicalscience:" + loc + blockRegistryObject.getId().getPath() + appendix));
    }
